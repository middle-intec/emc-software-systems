...
$thang = $_GET['thang'];
$nam = $_GET['nam'];                                          
$ExportExcel = exportexcelNV($manv,$thang,$nam);
$i = 2; $stt = 1;
...
//    array_push($arrExportExcel, new ExportExcel($row["congty"], $row["tel"], $row["donvi"]));
    ...
    ->setCellValue('M'.$i, $duyet);
    $i++;
}
//ghi du lieu vao file,định dạng file excel 2007
$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment;filename="Thư Tư Vấn EMC theo NV.xlsx"');
